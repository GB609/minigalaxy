...
class Properties(Gtk.Dialog):
    ...
    def ok_pressed(self, button):
        ...
        """TODO: to be fully consistent, the start.sh generated by minigalaxy during install
        has to be re-generated when the custom wine path is changed for an installed game
