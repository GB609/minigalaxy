...
API_GET_INFO_TOONSTRUCK = {'downloads': {'installers': [
    ...
    {'id': 'installer_linux_en', 'name': 'Toonstruck', 'os': Platform.LINUX, 'language': 'en', 'language_full': 'English', 'version': 'gog-2', 'total_size': 963641344, 'files': [{'id': 'en3installer0', 'size': 963641344, 'downlink': 'https://api.gog.com/products/1207666633/downlink/installer/en3installer0'}]},
    {'id': 'installer_windows_fr', 'name': 'Toonstruck', 'os': Platform.WINDOWS, 'language': 'fr', 'language_full': 'français', 'version': '1.0', 'total_size': 985661440, 'files': [{'id': 'fr1installer0', 'size': 1048576, 'downlink': 'https://api.gog.com/products/1207666633/downlink/installer/fr1installer0'}, {'id': 'fr1installer1', 'size': 984612864, 'downlink': 'https://api.gog.com/products/1207666633/downlink/installer/fr1installer1'}]},
    ...
    {'id': 'installer_linux_fr', 'name': 'Toonstruck', 'os': Platform.LINUX, 'language': 'fr', 'language_full': 'français', 'version': 'gog-2', 'total_size': 1011875840, 'files': [{'id': 'fr3installer0', 'size': 1011875840, 'downlink': 'https://api.gog.com/products/1207666633/downlink/installer/fr3installer0'}]}
]}}
...
class TestApiGog(TestCase):
    ...
    def test_get_download_info(self):
        ...
        lang_variants = {
            "pl": {'id': 'installer_linux_en', 'name': 'Toonstruck', 'os': Platform.LINUX, 'language': 'en', 'language_full': 'English', 'version': 'gog-2', 'total_size': 963641344, 'files': [{'id': 'en3installer0', 'size': 963641344, 'downlink': 'https://api.gog.com/products/1207666633/downlink/installer/en3installer0'}]},
            "fr": {'id': 'installer_linux_fr', 'name': 'Toonstruck', 'os': Platform.LINUX, 'language': 'fr', 'language_full': 'français', 'version': 'gog-2', 'total_size': 1011875840, 'files': [{'id': 'fr3installer0', 'size': 1011875840, 'downlink': 'https://api.gog.com/products/1207666633/downlink/installer/fr3installer0'}]},
            "en": {'id': 'installer_linux_en', 'name': 'Toonstruck', 'os': Platform.LINUX, 'language': 'en', 'language_full': 'English', 'version': 'gog-2', 'total_size': 963641344, 'files': [{'id': 'en3installer0', 'size': 963641344, 'downlink': 'https://api.gog.com/products/1207666633/downlink/installer/en3installer0'}]}
        }
    ...
    def test_get_download_info_dlc(self):
        ...
        self.config.lang = "en"
        test_game = Game("Test Game")
        exp = {'id': 'installer_linux_en', 'name': 'Toonstruck', 'os': Platform.LINUX, 'language': 'en', 'language_full': 'English', 'version': 'gog-2', 'total_size': 963641344, 'files': [{'id': 'en3installer0', 'size': 963641344, 'downlink': 'https://api.gog.com/products/1207666633/downlink/installer/en3installer0'}]}
    ...
    def test_get_library_ok(self):
        ...
        api_responses = [
            ...
            {'totalPages': 1, 'products': [{'id': 1097893768, 'title': 'Neverwinter Nights: Enhanced Edition', 'image': '//images-2.gog-statics.com/8706f7fb87a4a41bc34254f3b49f59f96cf13d067b2c8bbfd8d41c327392052a', 'url': '/game/neverwinter_nights_enhanced_edition_pack', 'worksOn': {Platform.WINDOWS: True, 'Mac': True, Platform.LINUX: True}, "category": "Role-playing"}]},
            # for api.gog.com/products
            [{'id': 1097893768, 'content_system_compatibility': {Platform.WINDOWS: True}, "downloads": {"installers": [{"os": Platform.WINDOWS}]}}]
        ]
    ...
    def test_parse_productlist_json(self):
        ...
        expected = [
            Game(name="Pure Linux Game", game_id=22, platform=Platform.LINUX),
            Game(name="Pure Windows Game", game_id=32, platform="window"),
            Game(name="Mixed Game", game_id=42, platform=Platform.LINUX)
        ]
        game_list = []
    ...
    def test_get_version(self):
        test_game = Game("Test Game", platform=Platform.LINUX)
        exp = "gog-2"
    ...
    def test_get_version_dlc(self):
        ...
        game_info["expanded_dlcs"] = [{"title": dlc_name, "downloads": {"installers": [{"os": Platform.LINUX, "version": "1.2.3.4"}]}}]
        exp = "1.2.3.4"
